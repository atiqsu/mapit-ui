            ...
            <div class="rounded-2xl">
                <div class="p-6 pt-10 bg-white">
                    <div class="text-center mb-6">
                        ...
                        <h3 class="text-[20px] font-medium text-[#1C1E38]">Update project info</h3>
                        <p class="text-sm text-[#5E606E]">Update project details</p>
                    </div>
                    <div class="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                type="text" id="sname" name="sname" placeholder="Dummy">
                        </div>
                        <div>
                            <label class="text-sm font-semibold" for="scode">Study Code</label>
                            <input
                                class="block w-full focus:outline-none focus:ring focus:ring-[#4790FC] mt-3 rounded-lg bg-[#f8f9fb] border-0 p-4"
                                type="text" id="scode" name="scode" placeholder="SE- 2345">
                        </div>
                        <div>
                            <label class="text-sm font-semibold">User access details</label>
                            <table id="stbl" class="w-full mt-3 rounded-lg">
                                <tr>
                                    <th class="text-left text-[12px] p-3 bg-[#f8f9fb] ">User</th>
                                    <th class="text-left text-[12px] p-3 bg-[#f8f9fb] ">Access</th>
                                </tr>
                                <tr>
                                    <td class="text-[12px] p-3">Test User</td>
                                    <td class="p-3 flex items-center gap-2">
                                        <input type="checkbox" name="hasAccess" id="hasAccess1">
                                        <label class="text-[12px]" for="hasAccess1">HAs Access </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-[12px] p-3">Test User</td>
                                    <td class="p-3 flex items-center gap-2">
                                        <input type="checkbox" name="hasAccess" id="hasAccess2">
                                        <label class="text-[12px]" for="hasAccess2">HAs Access </label>
                                    </td>
                                </tr>
                ...
                <div class="bg-[#F8F9FB] p-6 flex items-center justify-end">
                    <button
                        class="border border-[#E9E9EC] bg-white py-2 px-3 font-medium text-[12px] rounded-xl mr-4">Cencel</button>
                    <button
                        class="bg-[#4790FC] hover:opacity-[0.8] duration-300 py-2 px-3 font-medium text-[12px] rounded-xl border border-[#E9E9EC] text-white">Save</button>
                </div>
            </div>
        </Modal>
