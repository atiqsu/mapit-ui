        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <div class="flex">
                ...
                <div class="w-full bg-white ps-[256px]">
                    <!-- Top Header -->
                    <div class="bg-white w-full shadow  border-b h-[fit-content] py-5 text-black">
                        <header>
                            <div class="hidden sm:flex sm:items-center px-5 justify-between items-center">
                                ...
                                <div
                                    ...
                                    <Link class="py-3 px-8  relative bg-[#fdd0d3] text-[#c12f30] "
                                        :class="{[activeLinkStyle] : isActive = 1}">
                                    Admin </Link>
                                    <Link class="py-3 px-8">
                                    Rules
                                    </Link>
                                ...
                                <div class="flex items-center gap-3">
                                    <!-- Notification Button -->
                                    <div>
                                        <button class="bg-white shadow p-3 rounded relative z-0">
                                            <div class="relative w-6">
                                                <img src="../../images/notify-icon.png" alt />
                                                <div
                                            ...
                                            <template #trigger>
                                                <span class="inline-flex rounded-md">
                                                    <button type="button"
                                                        ...
                                                        <span>
                                                            <img class="w-12" src="../../images/profile.webp" alt />
                                                        </span>
